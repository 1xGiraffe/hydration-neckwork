...
describe('which revenue rows are the protocol’s', () => {
  ...
  it('leaves every other stream counted in full', () => {
    for (const stream of ['network_fee', 'xcm_execution_fee', 'hsm_revenue', 'ice_matched_fee', 'uniswap_v3_fee', 'liquidation_penalty', 'pepl_liquidation_profit', 'asset_reserve']) {
