...
export const activityTypes = ['all', 'transfer', 'trade', 'dca', 'liquidity', 'mm', 'xcm', 'stake', 'vote', 'otc', 'bond', 'intent', 'xcswap']
...
const NARROW_ACTIVITY_TYPES = new Set(['vote', 'staking', 'otc', 'bond', 'intent', 'xcswap'])
