...
- 'revenue' — what the protocol earns. Totals for the day, week, month and all time; the split by stream (HOLLAR borrow interest, Omnipool asset and protocol fees, liquidation penalties, HSM revenue, network fees, Uniswap v3 fees, asset reserve); the accounts that generated the most; the live per-block accrual drips; and the HDX distributed to stakers from the three pots. 'range' (30d / 1y / all) applies HERE and only here.
